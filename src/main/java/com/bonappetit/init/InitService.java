...
public class InitService implements CommandLineRunner {
    ...
    private Map<CategoryName,String> descriptions = Map.of(
    ...
    public void run(String... args) throws Exception {
        ...
        List<Category> toInsert = Arrays.stream(CategoryName.values()).map(cat -> new Category(cat, descriptions.get(cat))).toList();
